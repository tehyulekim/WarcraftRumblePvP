...
N_CONNECTION_ERROR_OK_BUTTON_L = (0.43044189852700493, 0.5995115995115995)
N_CONNECTION_ERROR_OK_BUTTON_R = (0.43044189852700493, 0.5995115995115995)
...
N_SESSION_BUTTON_L = (0.4, 0.65) # calc at Experiment, must not overlap with PvP Search Cancel button
